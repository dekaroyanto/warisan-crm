...
const columns = [
   ...
   //    {
   //       key: "prev_month",
   //       label: "Previous Month's Total Transation",
   //    },
   //    {
   //       key: "action",
   //       label: "ACTION",
...
const users = [
   {
      id: 1,
      username: "MAHIRA RIFZA",
      account_number: "0102000057722",
      name: "DARMINI",
      store: "20001 - PT. TRANS GROSIR INDONESIA",
      status: "ACTIVE",
   },
];
...
export default function ProductProfile() {
   ...
   const setActionButton = () => {
      return (
         <div className="relative flex items-center gap-2">
            ...
            <Tooltip content="View Prepaid Cards" closeDelay={0}>
               <span
                  className="text-lg text-default-400 cursor-pointer active:opacity-50"
                  onClick={() => {
                     handleOpenModal("view");
   ...
   const setActionButton2 = (e) => {
      ...
      const isActive = e.status == "ACTIVE" && true;
      ...
      return (
         <div className="relative flex items-center gap-2">
            ...
            {isActive ? (
               ...
               <span className="text-lg text-default-400 cursor-not-allowed active:opacity-50">
                  <Image
                     src={ICONS.SafetyStockIconDisable}
                     alt="icon"
                     width={28}
                  />
               </span>
   ...
   return (
      <div className="md:container mx-auto py-2 pb-10">
         <h1 className="text-5xl font-thin text-title mb-6 mt-4">Member</h1>
