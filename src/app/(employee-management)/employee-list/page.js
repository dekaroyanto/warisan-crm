...
const users = [
  {
    id: 1,
    username: "700004060353",
    account_number: "00004060353	",
    employee: "LIEBERTY",
    registered_store: "MM-Head Office Jakarta	",
    status: "ACTIVE",
    prev_month: "",
  },
];
...
export default function ProductProfile() {
  ...
  return (
    <div className="md:container mx-auto py-2 pb-10">
      <h1 className="text-5xl font-thin text-title mb-6 mt-4">Employees</h1>
