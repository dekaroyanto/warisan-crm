      ...
      <ModalBody>
        <div className="w-full grid grid-cols-12 gap-4">
          <div className="col-span-6">
            ...
            />
            {props.touched.sales_order_no && props.errors.sales_order_no ? (
          ...
          <Button className="secondary" type="button" color="primary">
            🔍
          </Button>
          ...
          />
          {props.touched.contact_person && props.errors.contact_person ? (
            <div className="text-md text-primary font-semibold">
          ...
          />
          {props.touched.total_face_amount && props.errors.total_face_amount ? (
            <div className="text-md text-primary font-semibold">
          ...
          />
          {props.touched.shipping_fee && props.errors.shipping_fee ? (
            <div className="text-md text-primary font-semibold">
            ...
            <>
              <div className="grid grid-cols-12 mt-3">
                <div className="grid grid-cols-11 gap-3 col-span-11 rounded-md bg-primary py-2 px-4 text-white font-semibold">
                  ...
                  <p className="col-span-1 capitalize font-medium">Quantity</p>
                  <p className="col-span-2 capitalize font-medium">
                    Face Amount
                  </p>
                  <p className="col-span-2 capitalize font-medium">Card Fee</p>
                      ...
                      <div className="grid grid-cols-11 gap-2 col-span-11">
                        <div className="col-span-3">
                          <select
                            ...
                            {...props.getFieldProps(`cards.${index}.cardType`)}
                          >
                            {cardType?.map((e) => (
                        ...
                        <Input
                          ...
                          variant="bordered"
                          required
                          {...props.getFieldProps(`cards.${index}.faceValue`)}
                        />
                        <Input
                          ...
                          placeholder="0"
                          required
                          {...props.getFieldProps(`cards.${index}.qty`)}
                        />
                        ...
                        <Input
                          ...
                          {...props.getFieldProps(`cards.${index}.expDate`)}
                        />
                        <Input
                          isRequired
                          size="lg"
                        ...
                        <Checkbox
                          ...
                          {...props.getFieldProps(`cards.${index}.expLatter`)}
                        >
                          Free Print Fee
                        </Checkbox>
                      </div>
