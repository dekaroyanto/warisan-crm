                      ...
                      {({ insert, remove, push }) => (
                        <>
                          <ModalBody>
                            ...
                            {formik.values.card.length > 0 &&
                              formik.values.card.map((e, index) => (
                                <div key={index} className="grid grid-cols-12">
                                  <div className="grid grid-cols-8 gap-2 col-span-11">
                                    <Select
                                      ...
                                      label="Card Type"
                                      variant="bordered"
                                      name={`card.${index}.card_type`}
                                      // selectedKeys={formik.values.card}
                                      // onChange={formik.handleChange}
                                      {...formik.getFieldProps(
                                        `card.${index}.card_type`
                                      )}
                                    >
                                      {cardType.map((e) => (
                                        <SelectItem
